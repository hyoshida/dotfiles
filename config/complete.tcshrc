...
if ($?complete) then
    ...
    complete gdb \
        ...
        'n/*/c/'
    complete ar \
        'c/[dmpqrtx]/"(c l o u v a b i)"/' 'p/1/"(d m p q r t x)"//' \
        'p/2/f:*.a/ p/*/f:*.o/'
    complete perl \
        'n/-S/c/'
    ...
    complete gzip \
        'n/-d/f:*.{gz,Z,tgz,TGZ}/' \
        'n/*/f:^*.{gz,Z,tgz,TGZ}/'
    complete {gunzip,gzcat,zcat} \
        'n/*/f:*.{gz,Z,tgz,TGZ}/'
    complete com{,press} \
        'n/*/f:^*.Z/'
    complete unc{,ompress} \
        'n/*/f:*.Z/'
    #complete tar \
    #    'n/*/f:*.{gz,Z,tar.gz,tgz,TGZ,tar.bz2}/'
    
    # Tex
    complete {*latex,'tex2*'} \
        'n/*/f:*.{tex,TEX,texi,ltx}/'
    complete {ghostview,'gv*'} \
        'c/-l/(andscape)/' \
        'n/*/f:*.{ps,eps,pdf}/'
    complete {dvi*,x*dvi} \
        'n/*/f:*.{dvi,DVI}/'
    ...
    complete 'ps\*' \
        'n/*/f:*.{ps,eps,PS,EPS}/'
    complete {gs,gv,ghostview} \
        'n/*/f:*.{ps,PS,eps,epsi,epsf,pdf,PDF}/'
    complete {acroread,xpdf} \
        'n/*/f:*.{pdf,PDF}/'
    complete 'tgif*' \
        'n/*/f:*.obj/'
    complete {vi,xvi,m,more} \
        'n/*/f:^*.{o,a,so,so.*}/'
    
    # Print
    complete lpr \
        'c/-P/$printers/' 'n/*/f:*.{ps,eps}/'
    complete lpq \
        'c/-P/$printers/'
    complete lprm \
        'c/-P/$printers/'
    complete dvips \
        'c/-P/$printers/' 'n/-o/f:*.{ps,PS}/' 'n/*/f:*.dvi/'
